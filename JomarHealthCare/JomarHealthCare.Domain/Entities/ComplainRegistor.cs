...
public class ComplainRegistor
{
    ...
    public virtual ICollection<ComplainRegistorClients> ComplainRegistorClients { get; set; }
    public virtual ICollection<ComplainRegistorStaff> ComplainRegistorStaff { get; set; }
}
