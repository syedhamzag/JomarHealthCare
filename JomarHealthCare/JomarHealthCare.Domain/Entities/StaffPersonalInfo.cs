...
namespace JomarHealthCare.Domain.Entities
{
    public class StaffPersonalInfo
    {
        public StaffPersonalInfo()
        {
            ...
            TrainingByList = new HashSet<StaffTrainingByList>();
        }
        ...
        public virtual ICollection<ComplainRegistorStaff> ComplainRegistorStaff { get; set; } = new HashSet<ComplainRegistorStaff>();
        ...
        public virtual ICollection<StaffTrainingByList> TrainingByList { get; set; }

        public virtual CategoryOfStaff CategoryOfStaff { get; set; }
