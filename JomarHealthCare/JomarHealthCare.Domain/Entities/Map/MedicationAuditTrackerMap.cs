...
{
    public class MedicationAuditTrackerMap : IEntityTypeConfiguration<MedicationAuditTracker>
    {
        public void Configure(EntityTypeBuilder<MedicationAuditTracker> builder)
        {
            builder.ToTable("tbl_MedicationAuditTracker");
