...
{
    public class CreateAppointmentBookingHandler : IRequestHandler<CreateAppointmentBookingCommand, AppointmentBookingDataModel>
    {
        ...
        public CreateAppointmentBookingHandler(IEmailService emailService, IStaffPersonalInfoRepository staffPersonalInfoRepository, IClientRepository clientRepository, IAppointmentBookingRepository repo, IMapper mapper, IUnitOfWork uow)
        {
            _repo = repo;
            _mapper = mapper;
            _uow = uow;
        ...
        public async Task<AppointmentBookingDataModel> Handle(CreateAppointmentBookingCommand request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<AppointmentBookingDataModel>(created);
        }
    }
