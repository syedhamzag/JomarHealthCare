...
{
    public class UpdateRegisterDeductionCommandValidator: AbstractValidator<UpdateRegisterReductionCommand>
    {
        public UpdateRegisterDeductionCommandValidator()
        {
            RuleFor(c => c.CompanayId)
